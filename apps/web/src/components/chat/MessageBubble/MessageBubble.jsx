            ...
            <div className={clsx('flex-1 min-w-0 max-w-4xl', isUser && 'text-right')}>
                    ...
                    {!isUser && thinkingContent && (
                        <div className="mb-4">
                            <button
                                ...
                                className="flex items-center gap-2 text-xs font-mono text-amber-500/80 hover:text-amber-400 transition-all duration-200 focus-visible:ring-2 focus-visible:ring-amber-500"
                            >
                                <span 
                                    className={clsx(
                ...
                {!isUser && (
                    <div className="flex items-center gap-2 mt-2 opacity-0 group-hover:opacity-100 transition-all duration-200">
                        <button
                            onClick={handleCopy}
                            className="p-1.5 text-zinc-500 hover:text-zinc-200 hover:bg-zinc-800 rounded-md transition-all duration-150 active:scale-90 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-blue-500"
                        ...
                        {onRetry && (
                            <button
                                ...
                                disabled={isRetrying}
                                className={clsx(
                                    "p-1.5 rounded-md transition-all duration-150 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-blue-500",
                                    isRetrying 
